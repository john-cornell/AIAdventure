 ...
 */
export async function callLocalLLM(systemPrompt, messageHistory, jsonFields) {
 ...
 */
export async function getAvailableOllamaModels(url) {
    const config = loadConfig();
 ...
 */
export async function callLocalLLMWithRetry(systemPrompt, messageHistory, jsonFields, maxRetries = 3) {
    let lastError;
